...
const ITEMS = [
  {
    id: "github", label: "GITHUB", handle: "@SatyajeetChavan30", href: "https://github.com/SatyajeetChavan30", icon: "🐙", barIcon: icon1,
    details: [
      { label: "USER", value: "SatyajeetChavan30", icon: "👤" },
      { label: "ROLE", value: "Full Stack Dev", icon: "💻" },
      { label: "LOC", value: "Pune, India", icon: "📍" }
    ],
    stats: [],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "Satyajeet Chavan", href: "https://www.linkedin.com/in/satyajeetchavan/", icon: "💼", barIcon: icon2,
    details: [
      { label: "USER", value: "Satyajeet Chavan", icon: "👤" },
      { label: "ROLE", value: "Full Stack Dev", icon: "💻" },
  ...
  {
    id: "instagram", label: "INSTAGRAM", handle: "titanslayer1811", href: "https://www.instagram.com/titanslayer1811/", icon: "📷", barIcon: icon3,
    details: [
      { label: "USER", value: "titanslayer1811", icon: "👤" },
